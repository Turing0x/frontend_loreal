...
part of 'observar_million_provider.dart';
...
class TotalBrutoFamily extends Family<int> {
  ...
  /// See also [totalBruto].
  TotalBrutoProvider call(
    String jornal,
    String date,
  ) {
    return TotalBrutoProvider(
      jornal,
      date,
    );
  }
  ...
  @override
  TotalBrutoProvider getProviderOverride(
    covariant TotalBrutoProvider provider,
  ) {
    return call(
      provider.jornal,
      provider.date,
...
/// See also [totalBruto].
class TotalBrutoProvider extends AutoDisposeProvider<int> {
  /// See also [totalBruto].
  TotalBrutoProvider(
    this.jornal,
    this.date,
  ...
  bool operator ==(Object other) {
    return other is TotalBrutoProvider &&
        other.jornal == jornal &&
        other.date == date;
  }
