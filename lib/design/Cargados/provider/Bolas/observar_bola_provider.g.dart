...
part of 'observar_bola_provider.dart';
...
class TotalBrutoFamily extends Family<int> {
  ...
  /// See also [totalBruto].
  BolaTotalBrutoProvider call(
    String jornal,
    String date,
  ) {
    return BolaTotalBrutoProvider(
      jornal,
      date,
    );
  }
  ...
  @override
  BolaTotalBrutoProvider getProviderOverride(
    covariant BolaTotalBrutoProvider provider,
  ) {
    return call(
      provider.jornal,
      provider.date,
...
/// See also [totalBruto].
class BolaTotalBrutoProvider extends AutoDisposeProvider<int> {
  /// See also [totalBruto].
  BolaTotalBrutoProvider(
    this.jornal,
    this.date,
  ) : super.internal(
          (ref) => totalBruto(
  ...
  bool operator ==(Object other) {
    return other is BolaTotalBrutoProvider &&
        other.jornal == jornal &&
        other.date == date;
  }
